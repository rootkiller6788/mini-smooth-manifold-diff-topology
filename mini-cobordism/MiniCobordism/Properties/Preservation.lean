...
def kervaireInvariant (_M : SmoothManifold) : Nat := 0
def cobordismInvariantCatalogue : List String := ["Stiefel-Whitney numbers", "Pontryagin numbers", "Signature", "Euler characteristic", "Kervaire invariant", "Alpha-invariant", "A-hat genus", "Witten genus"]
