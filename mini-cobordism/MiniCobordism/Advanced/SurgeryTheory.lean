...
def surgeryProgram : List String := ["1. Normal invariant", "2. Surgery obstruction", "3. sigma(f)=0 iff normally cobordant"]
def novikovConjectureStatement : String := "Higher signatures are homotopy invariants"
def cobordismHypothesis : String := "Bord_n^fr free on point (Lurie)"
