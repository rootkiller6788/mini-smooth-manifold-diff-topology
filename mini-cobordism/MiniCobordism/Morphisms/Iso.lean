...
structure HCobordism (M N : SmoothManifold) where
  W : SmoothManifold
  h_hasBoundary : W.hasBoundary = true
  h_dim_relation : W.dim = M.dim + 1
def lGroupTrivialGroup (n : Nat) : String := match n % 4 with | 0 => "Z" | 1 => "0" | 2 => "Z/2Z" | 3 => "0" | _ => "?"
