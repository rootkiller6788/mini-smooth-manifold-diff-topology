...
def lGenusCoefficients (k : Nat) : String := match k with | 0 => "1" | 1 => "p_1/3" | 2 => "(7p_2-p_1^2)/45" | _ => "L_k"
def tqftExamples : List String := ["1+1: Frobenius algebras", "2+1: MTCs", "n-dim: Cobordism hypothesis"]
