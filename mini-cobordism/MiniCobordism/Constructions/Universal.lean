...
def moClassification : String := "MO(k) classifies unoriented cobordism"
def adamsSpectralSequence : String := "Ext_A(F_2, F_2) => pi_*^S"
def quillenTheorem : String := "MU is universal complex-oriented cohomology"
def nilpotenceTheorem : String := "f nilpotent iff MU_*(f) = 0"
def chromaticConvergence : String := "Sp = holim L_n Sp"
