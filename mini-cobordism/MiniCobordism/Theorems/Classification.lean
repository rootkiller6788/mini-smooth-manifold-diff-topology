...
theorem thom_unoriented_cobordism_ring : True := by trivial
theorem wall_oriented_cobordism_ring : True := by trivial
theorem milnor_novikov_complex_cobordism : True := by trivial
