...
def adamsSSComputeFramed (ts : Nat) : String :=
  match ts with | 0 => "Z" | 1 => "Z/2" | 3 => "Z/24" | 7 => "Z/240" | _ => "unknown"
def orderOfImJ (k : Nat) : Nat := match k with | 1 => 24 | 2 => 240 | 3 => 504 | 4 => 480 | _ => 0
def thetaGroup (n : Nat) : String := match n with | 7 => "Z/28" | 8 => "Z/2" | 11 => "Z/992" | _ => "?"
