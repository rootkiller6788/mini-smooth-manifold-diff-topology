...
theorem mo_representability : True := by trivial
theorem mu_universal_complex_oriented : True := by trivial
theorem landweber_exact_functor : True := by trivial
theorem hopkinsRavenel_chromatic_convergence : True := by trivial
theorem devinatzHopkinsSmith_nilpotence : True := by trivial
